...
const IntroBanner = ({ recipeData }: { recipeData: RecipeType[] }) => {
 ...
 // 랜덤 레시피
  ...
  return (
    <section className="mx-auto max-w-8xl px-5 pt-2 pb-10">
      <div className="grid md:grid-cols-2 gap-6 items-center rounded-3xl bg-white shadow-md p-7 md:p-10">
        <div>
          <h1 className="text-5xl md:text-5xl font-extrabold leading-snug text-stone-800">
          ...
          <Link
            ...
            className="mt-6 inline-block rounded-2xl bg-orange-400 px-5 py-3 font-semibold text-white shadow hover:bg-orange-500 transition"
          >
            추천 레시피 보기
          </Link>
        </div>
